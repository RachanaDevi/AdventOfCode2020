...
public class ReportRepairUnitTest {
    ...
    public void shouldFindTwoNumberProductGivenListHasOnlyTwoNumber() {
        ...
        numbers.add(1010);
        numbers.add(1010);
        assertThat(ReportRepair.findTwoNumbersProductWhoseSumIs2020(numbers), is(1020100));
    }
    ...
    public void shouldFindTwoNumbersProductGivenAListOfNumbers() {
        ...
        numbers.add(260);
        numbers.add(260);
        assertThat(ReportRepair.findTwoNumbersProductWhoseSumIs2020(numbers), is(346059));
    }
    ...
    public void shouldFindTwoNumbersGivenNumbersFromAnInputFile() throws IOException {
        ...
        assertThat(ReportRepair.findTwoNumbersProductWhoseSumIs2020(intNumbers), is(1006875));
    }
    ...
    public void shouldFindThreeNumberProductGivenListHasOnlyTwoNumber() {
        ...
        numbers.add(1010);
        numbers.add(10);
        assertThat(ReportRepair.findThreeNumbersProductWhoseSumIs2020(numbers), is(10100000));
    }
    ...
    public void shouldFindThreeNumbersProductGivenAListOfNumbers() {
        ...
        numbers.add(260);
        numbers.add(260);
        assertThat(ReportRepair.findThreeNumbersProductWhoseSumIs2020(numbers), is(3800000));
    }
    ...
    public void shouldFindThreeNumbersGivenNumbersFromAnInputFile() throws IOException {
        var numbers = new ArrayList<>(Files.readAllLines(Paths.get("src/test/resources/day1_sum_2020.txt")));
        var intNumbers = numbers.stream().map(Integer::parseInt).collect(Collectors.toList());
        assertThat(ReportRepair.findThreeNumbersProductWhoseSumIs2020(intNumbers), is(165026160));
    }
}